...
const LuxuryRooms = () => {
    return (
        <div className="flex flex-wrap justify-center mx-5   md:space-x-4 space-y-4">

            <div className="relative xl:w-80 xl:h-96 lg:w-56 lg:h-72 md:w-40 md:h-56 w-80 h-96 overflow-hidden mt-20  rounded-lg shadow-lg">
                <Image
            ...
            <div className="relative xl:w-80 xl:h-96 lg:w-56 lg:h-72 md:w-40 md:h-56 w-80 h-96   overflow-hidden rounded-lg  shadow-lg">
                <Image
            ...
            <div  className="relative xl:w-80 xl:h-96 lg:w-56 lg:h-72 md:w-40 md:h-56 w-80 h-96  imgemg overflow-hidden  rounded-lg shadow-lg">
                <Image

...
const Booking = () => {
    ...
    const bookNow = () => {
        ...
        window.open(
            `https://book-directonline.com/properties/RiverViewVillasdirect?locale=en&items[0][adults]=${adults}&items[0][children]=${children}&items[0][infants]=0&currency=${currency}&checkInDate=${chkin}&checkOutDate=${chkout}&trackPage=no`,
            '_blank'
        );
    };
    ...
    return (
        <form className="space-y-8">
                ...
                <div className="form-group">
                    ...
                    <div className="relative">
                        ...
                        <span className="absolute top-1/2 -translate-y-1/2 right-2">
                            <svg fill="#000000" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24"><path d="M2,19c0,1.7,1.3,3,3,3h14c1.7,0,3-1.3,3-3v-8H2V19z M19,4h-2V3c0-0.6-0.4-1-1-1s-1,0.4-1,1v1H9V3c0-0.6-0.4-1-1-1S7,2.4,7,3v1H5C3.3,4,2,5.3,2,7v2h20V7C22,5.3,20.7,4,19,4z" /></svg>
                        </span>
                    </div>
                </div>
                <div className="form-group">
            ...
            <button 
                type="button"
                className="sm:w-2/3 bg-customBlue text-white md:py-2 md:px-4 px-2 py-1 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                onClick={bookNow}
            >
                Book Now
            </button>
